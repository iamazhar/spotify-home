...
// MARK: - Extension on ItemCollectionViewCell to add the cell press down and scale animation
...
// MARK: - Extension on GridItemCollectionViewCell to add the cell press down and scale animation
extension GridItemCollectionViewCell {
    
    open override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        didScaleDownOnTouch = false
        self.setTouchDownState()
        super.touchesBegan(touches, with: event)
    }
