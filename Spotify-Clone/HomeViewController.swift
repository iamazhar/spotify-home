...
class HomeViewController: UIViewController, SPTAppRemotePlayerStateDelegate, SPTAppRemoteDelegate, SPTSessionManagerDelegate {
    ...
    var accessToken = UserDefaults.standard.string(forKey: kAccessTokenKey) {
        didSet {
            ...
            defaults.set(accessToken, forKey: HomeViewController.kAccessTokenKey)
        }
    }
